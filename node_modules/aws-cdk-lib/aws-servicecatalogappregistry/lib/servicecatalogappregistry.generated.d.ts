 ...
 * @stability experimental
 */
export interface IAttributeGroupRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IAttributeGroupAssociationRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IResourceAssociationRef extends constructs.IConstruct {
    /**
