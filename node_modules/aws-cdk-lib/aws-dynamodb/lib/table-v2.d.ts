...
import { Attribute, LocalSecondaryIndexProps, SecondaryIndexProps, StreamViewType, PointInTimeRecoverySpecification, TableClass, WarmThroughput, MultiRegionConsistency, ContributorInsightsSpecification } from 'aws-cdk-lib/aws-dynamodb/lib/shared';
