...
export class ApiStack extends Stack {
  constructor(scope: Construct, id: string, props: ApiStackProps) {
    ...
    const autherizer = new CognitoUserPoolsAuthorizer(
      this,
      "SpacesApiAuthorizer",
      {
    ...
    const optionsWithAuth: MethodOptions = {
      // when this is passed with the lambda integration it will automatically authenticate the request befire responding
